...
/**
 * VIEW
 * match list : public complete view
 *
 * @version $Id: match_list_public_complete.php 85 2014-08-27 10:18:51Z lezardro $
...
if( empty($matches)):
	...
	<div class="container"><div class="col-sm-3 block-btn"><a href="<?php echo site_url('exporter-matches'); ?>">
		...
		<div class=" col-sm-offset-2 col-sm-2 block-btn "><a href="<?php echo site_url('matches/recherche-simple'); ?>">
				<button type="button" class="btn btn-default btn-xs action-btn">Vue simplifiée</button>
			</a>
		</div>
	</div>
<?php
...
<?php foreach ($matches as $match): ?>
		<tr>
			...
			<td>
				...
				<span class="status status_<?php echo $match->match_team1_status; ?>">(<?php echo $match->match_team1_status; ?>)</span></td>
			<td>
				<a href="<?php echo site_url('matches/t' . $match->match_team2); ?>">
					<?php echo $match->team2_name; ?>
				</a>
				<span class="status status_<?php echo $match->match_team2_status; ?>">(<?php echo $match->match_team2_status; ?>)</span></td>
			<td><?php echo $match->referee1_club_name;
			...
			?></td>
			<td><?php echo $match->referee2_club_name;
