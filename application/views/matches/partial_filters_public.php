...
/**
 * VIEW
 * partial view : filters for light search (public search)
 *
 * @version $Id: partial_filters_public.php 85 2014-08-27 10:18:51Z lezardro $
...
$options_cat = array(0 => '--') + $categories;
$default_cat = (isset($filters['cat'])? $filters['cat']:'');
$options_teams = array(0 => '--') + $teams;
$default_teams = (isset($filters['team'])? $filters['team']:'');
$options_where = array(
	'0' => "A domicile et à l'extérieur",
	'1' => "A domicile uniquement",
	'2' => "A l'extérieur uniquement"
);
$default_where = (isset($filters['place'])? $filters['place']:'');
...
<div class="col-sm-12">
	...
	<fieldset class="filters">
		...
		<div class="filter-content">
			...
			<div class="form-group">
			  <label for="f_team">Équipe</label>
			  <?php echo form_dropdown('f_team', $options_teams, $default_teams, 'class="form-control input-sm" id="f_team"'); ?>
			</div>

			<div class="form-group">
			  <label for="f_where">Où</label>
			  <?php echo form_dropdown('f_where', $options_where, $default_where, 'class="form-control input-sm" id="f_where"'); ?>
			</div>
