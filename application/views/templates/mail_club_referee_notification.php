...
/**
 * TEMPLATE
 * mail template for summoning a club for referee
 *
 * @version $Id: mail_club_referee_notification.php 65 2014-03-03 09:01:25Z lezardro $
...
<div>
	...
	<p>Vous recevez ce message car vous devez positionner un arbitre sur la rencontre sportive suivante :<br>
	...
	<p>Merci de vous connecter sur le site <?php echo site_url('connexion'); ?> afin de compléter les informations.</p>
	...
	<p class="end-of-message">Vous recevez ce message car vous êtes correspondant arbitre club.<br>
