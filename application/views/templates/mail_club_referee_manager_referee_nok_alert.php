 ...
 *
 * @version $Id: mail_club_referee_manager_referee_nok_alert.php 65 2014-03-03 09:01:25Z lezardro $
...
<div>
	...
	<p>Vous recevez ce message car l'arbitre positionné sur la rencontre sportive suivante
	...
	<p>Merci de vous connecter sur le site <?php echo site_url('connexion'); ?> afin de positionner un autre arbitre.</p>
	...
	<p class="end-of-message">Vous recevez ce message car vous êtes correspondant arbitrage de votre club.<br>
