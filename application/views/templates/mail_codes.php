...
/**
 * TEMPLATE
 * mail template to send personal codes
 *
 * @version $Id: mail_codes.php 87 2014-09-14 16:33:21Z lezardro $
...
<div>
	...
	<p>Vous trouverez ci-dessous vos codes d'accès au site :<br>
		Identifiant : <?php echo $login; ?><br>
		Mot de passe : <?php echo $password; ?>
	</p>

	<p>Pour vous connecter au site, allez sur : <?php echo site_url('connexion'); ?>.</p>
	...
	<p class="end-of-message">Vous recevez ce message car vous êtes susceptible de vous connecter au site.<br>
