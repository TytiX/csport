...
/**
 * TEMPLATE
 * mail template for alerting a club referee manager
 *
 * @version $Id: mail_club_referee_manager_alert.php 65 2014-03-03 09:01:25Z lezardro $
...
<div>
	...
	<p>Vous recevez ce message car votre club doit convoquer un arbitre pour la rencontre sportive suivante,
		avant la transmission de la convocation au club reçu :<br>
	...
	<p>Merci de vous connecter sur le site <?php echo site_url('connexion'); ?> afin de compléter les informations requises.</p>
	...
	<p class="end-of-message">Vous recevez ce message car vous êtes correspondant arbitrage de votre club ou correspondant club.<br>
